...
.clay-color-dropdown-menu {
  ...
  .clay-color-dropdown-menu .component-action:focus, .clay-color-dropdown-menu .component-action.focus {
    box-shadow: 0 0 0 0.2rem rgba(0, 123, 255, 0.25);
    color: #000; }
  .clay-color-dropdown-menu .component-action:not([disabled]):not(.disabled):active:focus, .clay-color-dropdown-menu .component-action:not([disabled]):not(.disabled).active:focus,
